...
# 获取收益率数据的函数
def get_ret_from_excel(ts_code, start_date, end_date, excel_path='C:\\Python程序设计基础\\pythonProject1\\日线数据.xls', sheet_name='黄金+铜+原油'):
...
if __name__ == "__main__":
    ...
    weights_df.to_excel('monthly_weights_AU_CU_SC.xlsx')
    print(weights_df1)
    print(weights_df2)
    print(weights_df)
