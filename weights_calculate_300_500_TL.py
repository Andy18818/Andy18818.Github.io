...
# 获取收益率数据的函数
def get_ret_from_excel(ts_code, start_date, end_date, excel_path='C:\\Python程序设计基础\\pythonProject1\\日线数据.xls', sheet_name='300+500+国债'):
...
if __name__ == "__main__":
    ts_code = ['510300.SH', '513500.SH', 'TL.CFX']
    start_date = '20180630'
    end_date = '20240325'
    ...
    weights_df.to_excel('monthly_weights_300_500_TL.xlsx')
    print(weights_df1)
    print(weights_df2)
    print(weights_df)
